...
class Mage_Catalog_Helper_Category_Flat extends Mage_Catalog_Helper_Flat_Abstract
{
    ...
    /**
     * Check if Catalogs Category Flat Data has been initialized
     *
