...
class Mage_Catalog_Helper_Product_Flat extends Mage_Catalog_Helper_Flat_Abstract
{
    ...
    /**
     * Catalogs Flat Product index process code
     */
    const CATALOG_FLAT_PROCESS_CODE = 'catalog_product_flat';

    /**
     * Catalogs Product Flat index process code
     *
     * @var string
     */
    ...
    /**
     * Catalogs Product Flat index process instance
     *
    ...
    /**
     * Store flags which defines if Catalogs Product Flat functionality is enabled
     *
    ...
    /**
     * Catalogs Product Flat Flag object
     *
    ...
    /**
     * Retrieve Catalogs Product Flat Flag object
     *
    ...
    /**
     * Check Catalogs Product Flat functionality is enabled
     *
    ...
    /**
     * Check if Catalogs Product Flat Data has been initialized
     *
    ...
    /**
     * Check if Catalogs Product Flat Data has been initialized for all stores
     *
     * @return bool
     */
