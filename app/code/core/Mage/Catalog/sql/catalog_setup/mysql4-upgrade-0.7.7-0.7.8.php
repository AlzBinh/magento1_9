...
$installer->run("
    ...
    CREATE TABLE `{$this->getTable('catalog_product_entity_media_gallery')}` (
      ...
      ) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Catalogs product media gallery';
    ...
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Catalogs product media gallery values';
    ...
    ) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Catalogs product media gallery images';
");
