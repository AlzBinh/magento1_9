...
/**
 * Catalogs Product Flat Indexer Resource Model
 *
 * @category    Mage
 * @package     Mage_Catalog
...
class Mage_Catalog_Model_Resource_Product_Flat_Indexer extends Mage_Index_Model_Resource_Abstract
{
    ...
    /**
     * Rebuild Catalogs Product Flat Data
     *
    ...
    /**
     * Retrieve Catalogs Product Flat helper
     *
    ...
    /**
     * Retrieve Catalogs Entity Type Id
     *
     * @return int
     */
    ...
    /**
     * Retrieve Catalogs Product Flat Table name
     *
     * @param int $storeId
     * @return string
     */
    ...
    public function prepareFlatTable($storeId)
    {
        ...
        if (count($indexesNeed) > $maxIndex) {
            Mage::throwException(Mage::helper('catalog')->__("The Flat Catalogs module has a limit of %2\$d filterable and/or sortable attributes. Currently there are %1\$d of them. Please reduce the number of filterable/sortable attributes in order to use this module", count($indexesNeed), $maxIndex));
        }
        ...
        if (!$this->_isFlatTableExists($storeId)) {
            ...
            $table->setComment("Catalogs Product Flat (Store {$storeId})");
    ...
    /**
     * Transactional rebuild Catalogs Product Flat Data
     *
     * @return Mage_Catalog_Model_Resource_Product_Flat_Indexer
     */
