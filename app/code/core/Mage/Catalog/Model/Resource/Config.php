...
/**
 * Catalogs Config Resource Model
 *
 * @category    Mage
 * @package     Mage_Catalog
...
class Mage_Catalog_Model_Resource_Config extends Mage_Core_Model_Resource_Db_Abstract
{
    ...
    /**
     * Retrieve Product Attributes Used in Catalogs Product listing
     *
     * @return array
     */
    ...
    /**
     * Retrieve Used Product Attributes for Catalogs Product Listing Sort By
     *
     * @return array
     */
