...
/**
 * Catalogs Product visibilite model and attribute source model
 *
 * @category   Mage
 * @package    Mage_Catalog
...
//        $collection->addAttributeToFilter('visibility', array('in'=>$this->getVisibleInCatalogIds()));
    ...
    static public function getOptionArray()
    {
        return array(
            ...
            self::VISIBILITY_IN_CATALOG => Mage::helper('catalog')->__('Catalogs'),
            self::VISIBILITY_IN_SEARCH  => Mage::helper('catalog')->__('Search'),
            self::VISIBILITY_BOTH       => Mage::helper('catalog')->__('Catalogs, Search')
        );
    }
    ...
    public function getFlatColums()
    {
        ...
        if (Mage::helper('core')->useDbCompatibleMode()) {
            ...
            $column['comment']  = 'Catalogs Product Visibility ' . $attributeCode . ' column';
        }
