...
/**
 * Catalogs Product Flat Indexer Model
 *
...
{
    /**
     * Catalogs product flat entity for indexers
     */
    ...
    /**
     * Update Catalogs Product Flat data
     *
     * @param int|array $productIds
     * @param int $store
     * @return Mage_Catalog_Model_Product_Flat_Indexer
    ...
    /**
     * Save Catalogs Product(s) Flat data
     *
     * @param int|array $productIds
     * @param int $store
     * @return Mage_Catalog_Model_Product_Flat_Indexer
    ...
    /**
     * Rebuild Catalogs Product Flat Data for all stores
     *
     * @return Mage_Catalog_Model_Product_Flat_Indexer
     */
