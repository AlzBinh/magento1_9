...
/**
 * Catalogs Product Flat observer
 *
 * @category   Mage
 * @package    Mage_Catalog
...
class Mage_Catalog_Model_Product_Flat_Observer
{
    ...
    /**
     * Retrieve Catalogs Product Flat Indexer model
     *
    ...
    /**
     * Catalogs Entity attribute after save process
     *
    ...
    /**
     * Catalogs Product Status Update
     *
     * @param Varien_Event_Observer $observer
     * @return Mage_Catalog_Model_Product_Flat_Observer
     */
    ...
    /**
     * Catalogs Product Website(s) update
     *
     * @param Varien_Event_Observer $observer
     * @return Mage_Catalog_Model_Product_Flat_Observer
     */
    ...
    /**
     * Catalogs Product Import After process
     *
     * @param Varien_Event_Observer $observer
     * @return Mage_Catalog_Model_Product_Flat_Observer
     */
