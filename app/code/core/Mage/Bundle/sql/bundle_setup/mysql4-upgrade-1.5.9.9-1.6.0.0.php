...
$tables = array(
    $installer->getTable('bundle/option') => array(
        ...
        'comment' => 'Catalogs Product Bundle Option'
    ),
    $installer->getTable('bundle/option_value') => array(
        ...
        'comment' => 'Catalogs Product Bundle Option Value'
    ),
    $installer->getTable('bundle/selection') => array(
        ...
        'comment' => 'Catalogs Product Bundle Selection'
    ),
    $installer->getTable('bundle/selection_price') => array(
        ...
        'comment' => 'Catalogs Product Bundle Selection Price'
    ),
    $installer->getTable('bundle/price_index') => array(
        ...
        'comment' => 'Catalogs Product Bundle Price Index'
    ),
    $installer->getTable('bundle/stock_index') => array(
        ...
        'comment' => 'Catalogs Product Bundle Stock Index'
    ),
    $installer->getTable('bundle/price_indexer_idx') => array(
        ...
        'comment' => 'Catalogs Product Index Price Bundle Idx'
    ),
    $installer->getTable('bundle/price_indexer_tmp') => array(
        ...
        'comment' => 'Catalogs Product Index Price Bundle Tmp',
        'engine'  => 'InnoDB'
    ),
    $installer->getTable('bundle/selection_indexer_idx') => array(
        ...
        'comment' => 'Catalogs Product Index Price Bundle Sel Idx'
    ),
    $installer->getTable('bundle/selection_indexer_tmp') => array(
        ...
        'comment' => 'Catalogs Product Index Price Bundle Sel Tmp',
        'engine'  => 'InnoDB'
    ),
    $installer->getTable('bundle/option_indexer_idx') => array(
        ...
        'comment' => 'Catalogs Product Index Price Bundle Opt Idx'
    ),
    $installer->getTable('bundle/option_indexer_tmp') => array(
        ...
        'comment' => 'Catalogs Product Index Price Bundle Opt Tmp',
        'engine'  => 'InnoDB'
    )
);
