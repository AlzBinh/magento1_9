...
$table = $installer->getConnection()
    ...
    ->setComment('Catalogs Product Bundle Option');
...
$table = $installer->getConnection()
    ...
    ->addForeignKey($installer->getFkName('bundle/option_value', 'option_id', 'bundle/option', 'option_id'),
        ...
        Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
    ->setComment('Catalogs Product Bundle Option Value');
$installer->getConnection()->createTable($table);
...
$table = $installer->getConnection()
    ...
    ->addForeignKey($installer->getFkName('bundle/selection', 'product_id', 'catalog/product', 'entity_id'),
        ...
        Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
    ->setComment('Catalogs Product Bundle Selection');
$installer->getConnection()->createTable($table);
...
$table = $installer->getConnection()
    ...
    ->addForeignKey($installer->getFkName('bundle/selection_price', 'selection_id', 'bundle/selection', 'selection_id'),
        ...
        Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
    ->setComment('Catalogs Product Bundle Selection Price');
$installer->getConnection()->createTable($table);
...
$table = $installer->getConnection()
    ...
    ->addForeignKey($installer->getFkName('bundle/price_index', 'website_id', 'core/website', 'website_id'),
        'website_id', $installer->getTable('core/website'), 'website_id',
        Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
    ->setComment('Catalogs Product Bundle Price Index');
$installer->getConnection()->createTable($table);
...
$table = $installer->getConnection()
    ...
    ->setComment('Catalogs Product Bundle Stock Index');
$installer->getConnection()->createTable($table);
...
$table = $installer->getConnection()
    ...
    ->setComment('Catalogs Product Index Price Bundle Idx');
$installer->getConnection()->createTable($table);
...
$table = $installer->getConnection()
    ...
    ->setComment('Catalogs Product Index Price Bundle Tmp');
$installer->getConnection()->createTable($table);
...
$table = $installer->getConnection()
    ...
    ->setComment('Catalogs Product Index Price Bundle Sel Idx');
$installer->getConnection()->createTable($table);
...
$table = $installer->getConnection()
    ...
    ->setComment('Catalogs Product Index Price Bundle Sel Tmp');
$installer->getConnection()->createTable($table);
...
$table = $installer->getConnection()
    ...
    ->setComment('Catalogs Product Index Price Bundle Opt Idx');
$installer->getConnection()->createTable($table);
...
$table = $installer->getConnection()
    ...
    ->setComment('Catalogs Product Index Price Bundle Opt Tmp');
$installer->getConnection()->createTable($table);
