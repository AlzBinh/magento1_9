...
/**
 * Catalogs Price rules observer model
 */
class Mage_CatalogRule_Model_Observer
{
    ...
    protected function _checkCatalogRulesAvailability($attributeCode)
    {
        ...
        if ($disabledRulesCount) {
            ...
            Mage::getSingleton('adminhtml/session')->addWarning(
                Mage::helper('catalogrule')->__('%d Catalogs Price Rules based on "%s" attribute have been disabled.', $disabledRulesCount, $attributeCode));
        }
    ...
    /**
     * Runs Catalogs Product Price Reindex
     *
     * @param Varien_Event_Observer $observer
     */
