    ...
    public function getCatalogData()
    {
        ...
        return array(
            'refresh_catalog_rewrites'   => array(
                'label'     => Mage::helper('adminhtml')->__('Catalogs Rewrites'),
                'buttons'   => array(
                    array(
            ...
            'rebuild_catalog_index'         => array(
                'label'     => Mage::helper('adminhtml')->__('Rebuild Catalogs Index'),
                'buttons'   => array(
                    array(
            ...
            'rebuild_flat_catalog_category' => array(
                'label'     => Mage::helper('adminhtml')->__('Rebuild Flat Catalogs Category'),
                'buttons'   => array(
                    array(
            ...
            'rebuild_flat_catalog_product' => array(
                'label'     => Mage::helper('adminhtml')->__('Rebuild Flat Catalogs Product'),
                'buttons'   => array(
                    array(
