            ...
            switch ($catalogAction) {
                case 'refresh_catalog_rewrites':
                    try {
                        ...
                        $this->_getSession()->addSuccess(
                            Mage::helper('adminhtml')->__('The Catalogs Rewrites were refreshed.')
                        );
                    }
                        ...
                        $this->_getSession()->addException($e, Mage::helper('adminhtml')->__('An error occurred while refreshing the Catalogs Rewrites.'));
                    }
                    break;
                ...
                case 'rebuild_flat_catalog_product':
                    try {
                        ...
                        $this->_getSession()->addSuccess(Mage::helper('adminhtml')->__('The Flat Catalogs Product was rebuilt'));
                    }
                    catch (Mage_Core_Exception $e) {
                        $this->_getSession()->addError($e->getMessage());
                    }
